...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Scaffold placeholder mirroring React `CopilotChatUserMessage.stories.tsx`.",
      },
    },
  },
  render: () => ({
      ...
      <CopilotStoryLayout>
        <section style="padding: 24px 24px 40px">
          <h2 style="margin: 0 0 8px; font-size: 22px; line-height: 1.2">
            UI/CopilotChatUserMessage
          </h2>
          <p style="margin: 0; color: #64748b">
            Scaffold placeholder mirroring React \`CopilotChatUserMessage.stories.tsx\`.
          </p>
        </section>
      </CopilotStoryLayout>
    `,
